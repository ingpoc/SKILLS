...
8. Tool Organization at Scale
9. Transport Best Practices
10. Testing Requirements
11. OAuth and Security Best Practices
12. Resource Management Best Practices
13. Prompt Management Best Practices
...
### When to Use Tool Search (20+ tools)
...
- Format: `{service}_{domain}_{action}_{resource}`
- Examples: `slack_messages_send`, `slack_channels_list`, `slack_users_search`
...
- Include common synonyms and use cases
- Examples: "Send message to Slack channel or user (DM, post, reply)"

**Argument Naming:**

- Use descriptive, searchable names
- `channel_name_or_id` better than `target`
- `recipient_email` better than `to`

### defer_loading Configuration

**Server-side:** No changes needed (tools remain the same)

**Client-side (Claude Code/API):**
...
**Keep non-deferred:** 3-5 most frequently used tools

### Tool Categorization

- Use tool annotations for metadata
...
<Tabs>
  ...
  <Tab title="Python">
    ...
    **Note:** The official MCP Python SDK's `@mcp.tool()` decorator does not currently support the `annotations` parameter. Use clear descriptions and naming conventions for discoverability instead.
  </Tab>
</Tabs>
