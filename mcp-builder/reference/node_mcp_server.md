...
```typescript
server.registerTool(
  "service_domain_action_resource",
  {
    title: "Clear Action Title",
    description: "Clear purpose with semantic keywords for search. Include common use cases and synonyms.",
    inputSchema: z.object({
      descriptive_param_name: z.string().describe("Searchable param description with context")
    }).strict(),
    annotations: {
      readOnlyHint: true,
      category: "domain",  // Custom metadata
      tags: ["keyword1", "keyword2"]  // Searchability
    }
  },
...
- [ ] Input schema uses descriptive parameter names
- [ ] Zod `.describe()` provides searchable context
- [ ] Common synonyms and use cases in description
- [ ] Tool grouped with consistent prefix

**See:** [examples/searchable-tools.ts](../examples/searchable-tools.ts)
