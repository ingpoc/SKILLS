...
description: "Legacy compatibility hook setup for the older `.claude` enforcement model. Use only when maintaining that path. NOT for the Codex-first default baseline."
---
