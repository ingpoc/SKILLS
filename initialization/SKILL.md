...
description: "Legacy compatibility bootstrap for repos already using the older `.claude` lifecycle. Use only when maintaining that state-machine-based setup. NOT for the Codex-first default baseline — use repo-readiness-bootstrap and init-project."
---
